    ...
    <v-main>
        ...
        <div class="students">
            ...
            <div class="stats">
                ...
                <hr>
                <div class="prompt">Of those who preferred team, number of students with at least one preferred
                    member:
                </div>
                <div class="resp">{{totalTeam1Mem}} of {{totalTeamPref}}</div>
                <hr>
                <div class="prompt">Of those who preferred project, number of students who were assigned any project
                    they wanted:
                </div>
                <div class="resp">{{totalProj1Proj}} of {{totalProjPref}}</div>
                <hr>
                <div class="prompt">Of those with no preference, number who got either a team member OR project they
                    selected:
                </div>
                ...
                <tr v-for="student in students" :key="student.id">
                    <td>
                        <div>
                          ...
                          <span v-if="student.username !== null && student.username !== student.name">/{{student.username}}
                          </span>
                        </div>
                    </td>
                    <td>
