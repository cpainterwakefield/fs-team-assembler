  ...
  <div class="run">
    ...
    <div class="right-list">
      <span class="proj1" v-for="project in projects" :key="project.id">
        ...
        <hr>
        <div class="element1" v-for="(student, i) in students" :key="i">
          <div v-if="student.project_id === project.id && isPairedWithAvoid(student)" class="unhappy">&middot; {{student.name}}</div>
          <div v-else-if="student.project_id === project.id && isSatisfied(student)" class="satisfied">&middot; {{student.name}}</div>
